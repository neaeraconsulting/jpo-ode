...
@SpringBootTest(
    ...
    properties = {"ode.kafka.topics.raw-encoded-json.bsm=topic.RawEncodedBSMJsonRouterTest"})
...
class RawEncodedBSMJsonRouterTest {
  ...
  @Value("${ode.kafka.topics.raw-encoded-json.bsm}")
  ...
  void testListen() throws Exception {
    EmbeddedKafkaHolder.addTopics(rawEncodedBsmJson);
    ...
    try (InputStream inputStream = getClass().getClassLoader().getResourceAsStream(
      ...
      kafkaTemplate.send(rawEncodedBsmJson, json);
    }
