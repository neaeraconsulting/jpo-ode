...
@SpringBootTest(
    classes = {KafkaProducerConfig.class, KafkaConsumerConfig.class, RawEncodedTIMJsonRouter.class,
        RawEncodedJsonService.class, SerializationConfig.class, TestMetricsConfig.class},
    properties = {"ode.kafka.topics.raw-encoded-json.tim=topic.RawEncodedTIMJsonRouterTest"})
...
class RawEncodedTIMJsonRouterTest {
  ...
  @Value("${ode.kafka.topics.raw-encoded-json.tim}")
  private String rawEncodedTimJson;
  ...
  void testListen() throws Exception {
    EmbeddedKafkaHolder.addTopics(rawEncodedTimJson);
    ...
    try (InputStream inputStream = getClass().getClassLoader().getResourceAsStream(
      ...
      kafkaTemplate.send(rawEncodedTimJson, json);
    }
