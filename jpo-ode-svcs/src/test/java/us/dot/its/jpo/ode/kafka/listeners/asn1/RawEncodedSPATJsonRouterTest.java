...
@SpringBootTest(
    classes = {KafkaProducerConfig.class, KafkaConsumerConfig.class, RawEncodedSPATJsonRouter.class,
        RawEncodedJsonService.class, SerializationConfig.class, TestMetricsConfig.class},
    properties = {"ode.kafka.topics.raw-encoded-json.spat=topic.RawEncodedSPATJsonRouterTest"})
...
class RawEncodedSPATJsonRouterTest {
  ...
  @Value("${ode.kafka.topics.raw-encoded-json.spat}")
  private String rawEncodedSpatJson;
  ...
  void testListen() throws Exception {
    EmbeddedKafkaHolder.addTopics(rawEncodedSpatJson);
    ...
    try (InputStream inputStream = getClass().getClassLoader().getResourceAsStream(
      ...
      kafkaTemplate.send(rawEncodedSpatJson, json);
    }
