...
@SpringBootTest(
    classes = {KafkaProducerConfig.class, KafkaConsumerConfig.class, RawEncodedRTCMJsonRouter.class,
        RawEncodedJsonService.class, SerializationConfig.class, TestMetricsConfig.class},
    properties = {"ode.kafka.topics.raw-encoded-json.rtcm=topic.RawEncodedRTCMJsonRouterTest"})
@EnableConfigurationProperties
@ContextConfiguration(classes = {UDPReceiverProperties.class, OdeKafkaProperties.class,
    RawEncodedJsonTopics.class, KafkaProperties.class})
@DirtiesContext
class RawEncodedRTCMJsonRouterTest {

  @Value("${ode.kafka.topics.raw-encoded-json.rtcm}")
  private String rawEncodedRtcmJson;
  ...
  void testListen() throws Exception {
    EmbeddedKafkaHolder.addTopics(rawEncodedRtcmJson);
    ...
    try (InputStream inputStream = getClass().getClassLoader().getResourceAsStream(
      ...
      kafkaTemplate.send(rawEncodedRtcmJson, json);
    }
