...
@SpringBootTest(
    classes = {KafkaProducerConfig.class, KafkaConsumerConfig.class, RawEncodedSSMJsonRouter.class,
        RawEncodedJsonService.class, SerializationConfig.class, TestMetricsConfig.class},
    properties = {"ode.kafka.topics.raw-encoded-json.ssm=topic.RawEncodedSSMJsonRouterTest"})
...
class RawEncodedSSMJsonRouterTest {
  ...
  @Value("${ode.kafka.topics.raw-encoded-json.ssm}")
  private String rawEncodedSsmJson;
  ...
  void testListen() throws Exception {
    EmbeddedKafkaHolder.addTopics(rawEncodedSsmJson);
    ...
    try (InputStream inputStream = getClass().getClassLoader().getResourceAsStream(
      ...
      kafkaTemplate.send(rawEncodedSsmJson, json);
    }
