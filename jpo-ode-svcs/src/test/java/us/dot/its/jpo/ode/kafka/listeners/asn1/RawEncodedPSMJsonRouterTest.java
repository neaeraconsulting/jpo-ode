...
@SpringBootTest(
    classes = {KafkaProducerConfig.class, KafkaConsumerConfig.class, RawEncodedPSMJsonRouter.class,
        RawEncodedJsonService.class, SerializationConfig.class, TestMetricsConfig.class},
    properties = {"ode.kafka.topics.raw-encoded-json.psm=topic.RawEncodedPSMJsonRouterTest"})
...
class RawEncodedPSMJsonRouterTest {
  ...
  @Value("${ode.kafka.topics.raw-encoded-json.psm}")
  private String rawEncodedPsmJson;
  ...
  void testListen() throws Exception {
    EmbeddedKafkaHolder.addTopics(rawEncodedPsmJson);
    ...
    try (InputStream inputStream = getClass().getClassLoader().getResourceAsStream(
      ...
      kafkaTemplate.send(rawEncodedPsmJson, json);
    }
